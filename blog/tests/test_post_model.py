...
class PostModelTest(TestCase):
    ...
    def test_post_category_field_on_delete(self):
        field_on_delete = Post._meta.get_field('category').remote_field.on_delete
        self.assertEqual(field_on_delete, models.PROTECT)

    def test_post_category_field_related_name(self):
        field_related_name = Post._meta.get_field('category').remote_field.related_name
        self.assertEqual(field_related_name, 'categories')
    ...
    def test_post_tag_field_related_name(self):
        field_related_name = Post._meta.get_field('tag').remote_field.related_name
        self.assertEqual(field_related_name, 'tags')
    ...
    def test_post_value(self):
        ...
        self.assertEqual(post_fields_value.created_at.date(), timezone.now().date())
